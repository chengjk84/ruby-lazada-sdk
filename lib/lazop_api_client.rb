...
module LazopApiClient
    ...
    class Client
        ...
        def execute(request,accessToken = nil)
            ...
            sys_params[:partner_id] = 'lazop-sdk-ruby-20181207'
        ...
        def perform_get url,api_params,header_params
            ...
            res = JSON.parse(RestClient::Request.execute(:method => 'get', :url => url + param_str, :headers => header_params, :open_timeout => @open_timeout, :read_timeout => @read_timeout))
        ...
        def setOpenTimeout(openTimeout)
